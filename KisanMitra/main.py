...
UPLOAD_FOLDER = '/Users/DELL/OneDrive/Documents/Project_image'
...
def addagroproduct():
    if request.method=="POST":
        ...
        products=Addagroproducts(username=username,email=email,productname=productname,productdesc=productdesc,price=price,image=file)
